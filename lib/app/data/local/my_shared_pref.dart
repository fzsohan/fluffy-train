...
class MySharedPref {
  ...
  /// save token type
  static Future<void> setTokenType(String tokenType) =>
      _sharedPreferences.setString(_tokenType, tokenType);

  /// get token type
  static String? getTokenType() => _sharedPreferences.getString(_tokenType);
