...
class LocalizationService extends Translations {
  ...
  static Map<String, TextStyle> supportedLanguagesFontsFamilies = {
    ...
    'en': TextStyle(fontFamily: GoogleFonts.plusJakartaSans().fontFamily),
    'ar': TextStyle(fontFamily: GoogleFonts.plusJakartaSans().fontFamily),
  };
  ...
  static updateLanguage(String languageCode) async {
    ...
    await MySharedPref.setLocale(languageCode);
    if (!Get.testMode) {
